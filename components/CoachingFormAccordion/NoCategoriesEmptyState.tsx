...
export function NoCategoriesEmptyState({ studentName }: NoCategoriesEmptyStateProps) {
  return (
    <div className="relative">
      {/* Blurred background categories */}
      <div className="absolute inset-0 blur-sm opacity-30 pointer-events-none">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-5">
          {/* Mock category cards that will be blurred */}
          {Array.from({ length: 6 }).map((_, index) => (
            ...
            >
              <div className="w-10 h-10 rounded-full bg-blue-100 mb-2 lg:mb-3"></div>
